...
The releases for windows can be found on the [FreeXT website](https://freext.jakinventions.com/), and under [releases](https://github.com/JakInventions/FreeXT-Mobile/releases).
